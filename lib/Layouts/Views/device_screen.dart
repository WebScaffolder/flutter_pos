...
class _device_screenState extends State<device_screen> {
          ...
          builder: (context, snapshot) {
            ...
            return new ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  _device_tile(context, snapshot.data.documents[index], index),
            );
          })
    );
  }
  ...
  //device list item
  Widget _device_tile(context, document, index) {
    return ListTile(
      ...
      trailing: Text(document['devicetatus'],
          maxLines: 1,
